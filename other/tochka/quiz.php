...
<div class="cutter">
	...
	<?php $dev = '<div class="dev">
							...
							<a href="//quiz24.ru" target="_blank" class="tar">Разработано в QuizMethod.ru</a>
						</div>'; ?>
	...
	<main id="main">
			<div class="header">
				<p class="header_title"><span>Подберите септик</span> и закрепите <span>скидку 50%</span> на установку</small></p>
				<div class="progressBarSteps">
					<div class="stepsWrapper">
						<span class="steps-item step-1 active"><span>Вопрос 1 из 6</span></span>
						<span class="steps-item step-2"><span>Вопрос 2 из 6</span></span>
						<span class="steps-item step-3"><span>Вопрос 3 из 6</span></span>
						<span class="steps-item step-4"><span>Вопрос 4 из 6</span></span>
						<span class="steps-item step-5"><span>Вопрос 5 из 6</span></span>
						<span class="steps-item step-6"><span>Вопрос 6 из 6</span></span>
					</div>
			...
			<form  action="spasibo.php" method="post" class="quiz" id="quiz">
					...
					<div class="questions_block">
						...
						<div class="col_center switch_image blue_image">
							<div class="image_container">
								<img ondragstart="return false" src="assets/img/card-arrow.png">
								<p>Начните отвечать, чтобы  <br> система начала  <br> подбор септика</p>
								<img class="card-1-image" ondragstart="return false" src="./assets/img/card-1-image.png" alt="">
							</div>
							<!-- /.image_container -->
						</div>
						<!-- /.col_center -->
						<div class="col_right switch_image">
							<div class="present_block">
								<p><strong>Ещё <span>5</span> вопросов</strong> <br/> и вы получите результаты теста и подарок</p>
								<img ondragstart="return false" src="assets/img/present.png">
							</div>
						</div>
						<!-- /.col_right -->
					</div>
				...
				<div class="change_block nextInQueue" data-step="2">
					...
					<div class="questions_block">
						...
						<div class="col_right">
							<div class="present_block">
								<p><strong>Ещё 4 вопроса</strong><br/> и вы получите результаты теста и подарок</p>
				...
				<div class="change_block " data-step="3">
					...
					<div class="questions_block">
						...
						<div class="col_right">
							<div class="present_block">
								<p><strong>Ещё 3 вопроса</strong><br/> и вы получите результаты теста и подарок</p>
								<img src="assets/img/present.png">
							</div>
						</div>
						<!-- /.col_right -->
				...
				<div class="change_block " data-step="4">
					...
					<div class="questions_block">
						...
						<div class="col_right">
							<div class="present_block">
								<p><strong>Ещё 2 вопроса</strong><br/> и вы получите результаты теста и подарок</p>
								<img src="assets/img/present.png">
							</div>
						</div>
						<!-- /.col_right -->
				...
				<div class="change_block white_block" data-step="6">
					...
					<p class="system">Для точного расчета стоимости станции с установкой
нужно учесть следующие моменты:</p>
					...
					<div class="flex_form">
						<div class="col">
							...
							<ul class="flex_form_list">
								...
								<li>- pH воды на участке</li>
								<li>- характер грунта</li>
								<li>- особенности рельефа</li>
								<li>- стесненность условий</li>
							</ul>
							<p class="zamer">Чтобы получить точный расчет и зафиксировать стоимость с установкой, 
нужно заказать выезд инженера-замерщика</p>
							<div class="doc_block">
								<p class="doc_title">По результату выезда инженера Вы получите: </p>
								<ul class="doc_list">
									<li>Cмету в максимально развёрнутом виде</li>
									<li>Фиксированную стоимость станции с установкой</li>
								</ul>
							</div>
						</div>
						<!-- /.col -->
					...
					<div class="sale-container">
						<div class="sale-main">
							<h3 class="sale-header">
								<img src="./assets/img/sale-header-icon.png" ondragstart="return false" alt="">
								<p class="text">Бесплатный выезд <br/>и 50% скидка на установку</p> 
							</h3>
							<p class="sale-desc">Забронируйте бесплатный выезд инженера и скидку</p>
							<p class="sale-desc"><span>У вас есть 5 минут,</span><br/>количество бесплатных выездов ограничено.</p>
							<div class="sale-timers">
			
								<div class="sale-timers-amount">
									<p class="timer-title">Всего бесплатных<br/>выездов осталось:</p>
									<div class="icon">
										<img ondragstart="return false" src="./assets/img/timer-amount.png" alt="">
										<span class="amount"><strong id="amountOfFree"></strong><br/>Выездов</span>
									</div>
								</div>

								<div class="sale-timer-time">
									<p class="timer-title">До конца акции<br/>осталось:</p>
									<div class="circle">
										...
										<svg>
											...
											<defs>
												<linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
													...
													<stop offset="100%" stop-color="#f9b410" />
												</linearGradient>
											</defs>
											<circle stroke="url(#gradient)" class="progress" cx="45" cy="45" r="40"></circle>
										</svg>
									</div>
								</div>
							</div>
							<p class="sale-main-desc">* Правила акции: посмотрите зоны бесплатного выезда инженера >>></p>
							<div class="action action-1">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							...
							<div class="action action-5">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-6">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-7">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-8">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-9">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-10">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-11">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-12">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
							<div class="action action-13">
								<p class="action-title">Сергеи И.</p>
								<p class="action-text">забронировал выезд инженера <br/>г. Краснодар ул. Новая</p>
							</div>
						</div>
						<div class="form-free">
							<p class="form-title">Забронировать бесплатный выезд инженера</p>
							<p class="form-desc">Менеджер перезвонит и согласует адрес и удобную дату выезда инженера</p>
							<input class="form-input" type="text" name="phone" placeholder="7 (905) 111-22-33">
							<textarea class="form-textarea" type="text" name="text" placeholder="Укажите удобное время для звонка менеджера"></textarea>
							<button class="form-submit" type="button">Забронировать выезд инженера >></button>
						</div>
						<img class="form-man" src="./assets/img/from-man.png" ondragstart="return false" alt="">
					</div>
...
<?php if (!isset($_SERVER['HTTP_USER_AGENT']) || stripos($_SERVER['HTTP_USER_AGENT'], 'Chrome-Lighthouse') === false): ?>
	...
	<script type="text/javascript">
			...
			if ( !$('.percentage').hasClass('showArrow') && anim ){
				...
				$('.percentage').each(function () {
				   $(this).prop('Counter',0).animate({
			        ...
			        start: function () { $('.stepsWrapper').addClass("activated") },
	    ...
	    $("html:not(:animated),body:not(:animated)").animate({  scrollTop: destination-$head-50 }, 500);
		        ...
		        data: $(this).parents('form').serialize()
					...
					setInterval(() => {
						if(progress >= progressWidth) {
							...
							progress += ((progressWidth / 60) / 10)
						}
						$(".circle .progress").css("stroke-dashoffset", progress)
					}, 100);

					
					let amountOfFree = 13
					let amountOfFreeInterval = 15000
					$("#amountOfFree").text(amountOfFree)
					setInterval(() => {
						// amountOfFreeInterval = (20000 / amountOfFree) * Math.random() * 100
						if(amountOfFree > 1) {
							amountOfFree--
							$("#amountOfFree").text(amountOfFree)
							$(`.action-${amountOfFree}`).fadeIn(500)
							setTimeout(() => {
								$(`.action-${amountOfFree}`).fadeOut(500)
							}, 5000);
						}
					}, amountOfFreeInterval);
			...
			$('.change_block.active').animate({ 'opacity' : '0' }, .5)
